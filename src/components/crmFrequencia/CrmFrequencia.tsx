...
async function CrmFrequencia() {
  ...
  async function getInativo() {
    ...
    const url = `http://192.168.30.252:9091/api_crm/crm/frequencia.php?dataInicial='${dataInicial}'&dataFinal='${dataFinal}'&filial=${filial}`;
  ...
  const urlDownload = `http://192.168.30.252:9091/api_crm/crm/downloadRelFrequencia.php?dataInicial='${value.startDate}'&dataFinal='${value.endDate}'&filial=${filial}`;
  return (
    <>
      <div className="mt-2">
        ...
        <Select
          ...
          options={options}
          className="w-1/4 ml-2 mt-4"
        />
        <div className="w-96 mt-4 ml-2">
          <Datepicker
            showShortcuts={true}
            showFooter={true}
            primaryColor={"amber"}
      ...
      <div className="flex sm:text-xs md:text-sm">
        <table className="rounded-sm text-sm m-2 w-full bg-white ">
          <thead className="bg-gray-800 text-white h-8">
            <tr>
              ...
              <th className=" uppercase font-semibold text-sm ">T. Prod.</th>
              <th className=" uppercase font-semibold text-sm">Celular</th>
              <th className=" uppercase font-semibold text-sm">Dt. Cad.</th>
