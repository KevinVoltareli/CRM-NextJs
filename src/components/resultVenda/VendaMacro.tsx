    ...
    <>
      <div className="flex">
        <table className="m-2 w-96 bg-white">
          <thead className="bg-gray-800 text-white centered-div">
            <tr></tr>
          </thead>
        ...
        <div className="w-96 mt-2 ml-2">
          ...
          <button
            ...
            className="bg-white mt-2 w-1/3 rounded-md text-black-400 hover:bg-purple-700 hover:text-white transition ease-in-out delay-5"
            onClick={handleFetch}
          >
            Pesquisar
          </button>
