...
async function CrmVendas() {
  ...
  async function getInativo() {
    ...
    const url = `http://192.168.30.252:9091/api_crm/crm/venda.php?dataInicial='${dataInicial}'&dataFinal='${dataFinal}'&filial=${filial}`;
  ...
  const urlDownload = `http://192.168.30.252:9091/api_crm/crm/downloadRelTotal.php?dataInicial='${value.startDate}'&dataFinal='${value.endDate}'&filial=${filial}`;
